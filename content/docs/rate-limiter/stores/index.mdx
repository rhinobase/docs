...
| Store | Best For | Import Path |
|-------|----------|-------------|
| [MemoryStore](#memorystore) | Development, single-process apps | Built-in (default) |
| [RedisStore](/docs/rate-limiter/stores/redis) | Multi-server deployments | `hono-rate-limiter/stores/redis` |
| [WorkersKVStore](/docs/rate-limiter/stores/cloudflare) | Cloudflare Workers | `hono-rate-limiter/stores/cloudflare` |
| [DurableObjectStore](/docs/rate-limiter/stores/cloudflare) | Cloudflare Workers (precise) | `hono-rate-limiter/stores/cloudflare` |
| [UnstorageStore](/docs/rate-limiter/stores/unstorage) | Universal (any backend) | `hono-rate-limiter/stores/unstorage` |
