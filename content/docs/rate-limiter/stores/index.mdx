...
- [MemoryStore](#memorystore) - Default in-memory store
- [RedisStore](/docs/rate-limiter/stores/redis) - Redis-backed store
- [WorkersKVStore](/docs/rate-limiter/stores/cloudflare) - Cloudflare Workers KV store
- [DurableObjectStore](/docs/rate-limiter/stores/cloudflare) - Cloudflare Durable Objects store
- [UnstorageStore](/docs/rate-limiter/stores/unstorage) - Universal storage via Unstorage
